        ...
        <>
            <div className="fixed bottom-6 left-6 z-[900]">
                ...
                >
                    ...
                    <div className="absolute left-14 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded-xl bg-surface text-ink text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl border border-line">
                        Reportar problema
                    </div>
                </button>
            </div>
