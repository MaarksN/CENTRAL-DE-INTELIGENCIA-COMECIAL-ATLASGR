        ...
        <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-2 max-w-sm">
            {toasts.map((t) => {
                ...
                return (
                    <div
                        key={t.id}
                        className={`${bg} text-white px-4 py-3 rounded-xl shadow-lg flex items-start gap-2.5 text-sm font-medium animate-in slide-in-from-bottom-2 fade-in duration-200`}
                    >
