/**
 * @file LeadCanMovePipelineSpecification.ts
...
export class LeadCanMovePipelineSpecification implements ISpecification<Lead> {
  ...
  public and(other: ISpecification<Lead>): ISpecification<Lead> {
    const self: LeadCanMovePipelineSpecification = this;
    return {
