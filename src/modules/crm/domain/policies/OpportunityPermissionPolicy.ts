/**
 * @file OpportunityPermissionPolicy.ts
 * @description Politica de permissao de acesso relacionada a Opportunity.
 * @module CRM/Policies
 * @layer Domain
...
export class OpportunityPermissionPolicy {
  ...
  public canPerform(actor: CRMActor, action: CRMAction): boolean {
    if (!OpportunityPermissionPolicy.ALLOWED_ROLES.includes(actor.role)) {
      return false;
    }
