/**
 * @file PipelinePermissionPolicy.ts
 * @description Politica de permissao de acesso relacionada a Pipeline.
 * @module CRM/Policies
 * @layer Domain
...
export class PipelinePermissionPolicy {
  ...
  public canPerform(actor: CRMActor, action: CRMAction): boolean {
    if (!PipelinePermissionPolicy.ALLOWED_ROLES.includes(actor.role)) {
      return false;
    }
