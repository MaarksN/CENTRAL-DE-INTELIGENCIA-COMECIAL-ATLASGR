...
async function seed() {
    const users = [
        { name: 'Marcelo Nascimento', email: 'marcelo.nascimento@atlasgr.com.br', password: '123456' },
        { name: 'João Reis', email: 'joao.reis@atlasgr.com.br', password: '123456' },
        { name: 'Murilo Marques', email: 'murilo.marques@atlasgr.com', password: '123456' },
    ];
